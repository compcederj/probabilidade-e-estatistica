...
Repositório de provas antigas da Disciplina **Probabilidade e Estatística** do curso de **Tecnologia em Sistemas de Computaćao** da **UFF** ministrado através do **CEDERJ**.
...
`git clone https://github.com/compcederj/probabilidade-e-estatistica.git`
...
`git clone git@github.com:compcederj/probabilidade-e-estatistica.git`
...
# Probabilidade e Estatística
Repositório de provas antingas da Disciplina **Probabilidade e Estatística** do curso de **Tecnologia em Sistemas de Computaçao** da **UFF** ministrado através do **CEDERJ**.
